...
| HR / Filling positions | 11 | 11 |
| HR / General | 6 | 5 |
| HR / Position mgmt | 3 | 3 |
| HR / Rulemaking | 2 | 2 |
...
[`_meta/catalog/department-of-administrative-services-policies.yml`](../../../_meta/catalog/department-of-administrative-services-policies.yml). Not-ingested
rows are attachments/prior versions/link stubs without document numbers plus one
duplicate "- Copy" row. 10 documents (105-xxx rulemaking series and 107-004-053) are
image-only scans carried with `content_exception`.

## How to find the right policy

- **IT & Security**: 107-004-xxx (security cluster incl. 107-004-052 program policy).
