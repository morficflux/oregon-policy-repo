---
id: deq-imd-7070263
title: "Guidance for Evaluating VOC Emissions from Drying and Hot-Pressing Activities"
doc_type: policy
...
legal_authority: []
source_url: "https://ormswd2.synergydcs.com/ORMSCMSearchDEQ/Search/RecordViewer.aspx?uri=7070263"
source_format: pdf
retrieved: "2026-07-22"
source_sha256: "ed217a0906ffa7babf6b48bf1a538a7cf44ec8849ce67ce2be333b5c41b71d66"
effective_date: null
last_reviewed: null
source_version: "Year issued: 2007 (per the source listing)"
status: current
supersedes: null
...
> official text. Verify against the official source: <https://ormswd2.synergydcs.com/ORMSCMSearchDEQ/Search/RecordViewer.aspx?uri=7070263> (retrieved 2026-07-22).

# Guidance for Evaluating VOC Emissions from Drying and Hot-Pressing Activities (DEQ Internal Management Directive)

## At a glance

DEQ Internal Management Directive — Guidance for Evaluating VOC Emissions from Drying and Hot-Pressing Activities. Oregon Department of Environmental Quality. Issued 2007.
...
## Full text
                       ...
                       Internal Management Directive
                          Guidance for Evaluating VOC Emissions from Drying and
                       Hot-Pressing Activities Common to the Wood Products Industry

                  Effective Date:       January 2, 2007                     Pages:     14
                  Revision Date:
                       Approval:                                             AQ.00.011
...
4. Technical Discussion of the Shortcomings of Method 25A:
...
5.1        Wood Dryers
           ...
           Attachments 1 & 2 for more details on calculations and specific test methods.
            ...
            For direct-fired dryers that combust natural gas, ethane and/or methane may
...
5.2         Press Vents
      ...
      5.3   Sources Equipped with VOC BACT, RACT or LAER Control Technology
            ...
            commonly made for the bias. Methane and ethane are deemed to have “negligible
             ...
             photochemical reactivity” and are not regulated VOCs. Therefore, methane and
...
6.2      Reviewing source test results
...
7.1      Compliance issues discovered as a result of permit revision
       ...
       Note however, that creation of a compliance schedule will not absolve the source of
...
test results are addressed in equations A-3 and A-4.
                                            ...
                                            n
          Evoc = EFID + EFOR + EMOH +      Σ     Evoci         (Equation A-1)
                                           i=1
...
CALCULATION OF TERPENE EMISSIONS (EFID) FROM UNREFINED METHOD 25A TEST DATA
  ...
  retain a degree of conservatism in the test results.
               ⎡CM × RFM ⎤ ⎡ 2 × CE × RFE ⎤ ⎡CMOH × RFMOH ⎤ n NCi × Ci × RFi
CFID' = CFID − ⎢         ⎥−⎢              ⎥−⎢             ⎥ −∑               (Equation A-3)
               ⎣    3    ⎦ ⎣       3      ⎦ ⎣      3      ⎦ i =1    3
         Where:
...
CORRECTING VOC TEST RESULTS THAT ARE EXPRESSED AS CARBON OR AS METHANE
  ...
  CONVERSION FACTORS FOR CORRECTING VOC EMISSIONS DATA*
         ...
         VOC                  CONVERT                  CONVERT                 MULTIPLY
      PARAMETER                                                                   BY
                                FROM                        TO

         EPA 25A             AS CARBON                AS PROPANE                   1.22
       (TERPENES)

         EPA 25A            AS METHANE                AS PROPANE                   0.92
       (TERPENES)
  ...
  Notes:
   ...
   EXAMPLE CALCULATIONS TO DEMONSTRATE USE OF TABLE I CONVERSION FACTORS:
...
Correction of mass emission rate of terpenes as measured by EPA Method 25A:
                       ...
                       ⎡ E M × 44 ⎤ ⎡ E E × 2 × 44 ⎤ ⎡ E MOH × 0 . 55 × 44 ⎤
     E FID ' = E FID − ⎢          ⎥−⎢              ⎥−⎢                     ⎥ (Equation A-5)
                       ⎣ 3 × 16 ⎦ ⎣ 3 × 30 ⎦ ⎣               3 × 32        ⎦
...
Results: Test results from Method 25A are to be reported as ppmv (as propane) and mass
...
- Source: <https://ormswd2.synergydcs.com/ORMSCMSearchDEQ/Search/RecordViewer.aspx?uri=7070263> · retrieved 2026-07-22 · sha256 `ed217a0906ffa7babf6b48bf1a538a7cf44ec8849ce67ce2be333b5c41b71d66`
- Snapshot: `_meta/snapshots/deq-imd-7070263.pdf`
