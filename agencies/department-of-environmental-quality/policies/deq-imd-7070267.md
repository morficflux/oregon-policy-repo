---
id: deq-imd-7070267
title: "Hazardous Waste Fees for Remediation Wastes"
doc_type: policy
...
legal_authority: []
source_url: "https://ormswd2.synergydcs.com/ORMSCMSearchDEQ/Search/RecordViewer.aspx?uri=7070267"
source_format: pdf
retrieved: "2026-07-22"
source_sha256: "dd0e36820e56fbf14f09fc0a537a3e3d2d495e359d65a3ab3b5e379f95318717"
effective_date: null
last_reviewed: null
...
> official text. Verify against the official source: <https://ormswd2.synergydcs.com/ORMSCMSearchDEQ/Search/RecordViewer.aspx?uri=7070267> (retrieved 2026-07-22).

# Hazardous Waste Fees for Remediation Wastes (DEQ Internal Management Directive)

## At a glance

DEQ Internal Management Directive — Hazardous Waste Fees for Remediation Wastes. Oregon Department of Environmental Quality. Issued 2015.

## Full text

Hazardous Waste Fees for
Remediation Wastes
...
authorized hazardous waste management facilities.1 Historically, DEQ has not transferred these
provisional numbers to Your DEQ Online; therefore, DEQ has not charged a $200 fee for a
provisional RCRA number. This IMD creates a process for DEQ staff to input provisional
numbers into Your DEQ Online, and ensures that DEQ or EPA pay the fee, as required by
Oregon Revised Statute (ORS) 465.077.

The purpose of this IMD is to facilitate remediation of contaminated sites through cleanup
actions implemented under DEQ or EPA oversight by exempting hazardous waste generator fees
for remediation waste and investigation-derived waste (IDW) generated and managed on-site,
and reducing fees for IDW managed at off-site treatment, storage or disposal facilities. This IMD
aligns the DEQ’s generator fee structure with the level of effort required by the DEQ’s Resource,
Conservation and Recovery Act (RCRA) program in overseeing on- and off-site management
activities.
...
hazardous waste constituents. Under this policy, EPA has not defined this contaminated media as
...
1
 45 FR 85022, 85023 (December 24, 1980), rule related notice from Douglas M. Costle, Administrator
...
The $200 fee applies unless specifically exempted by ORS 465, Oregon Administrative Rule
...
Current rules provide no explicit exemption or consideration for media contaminated with
hazardous waste that are generated during cleanup actions, i.e., “remediation waste” and
“investigation-derived waste” (see definitions page 3), as distinguished from hazardous wastes
that are generated on an ongoing basis from industrial or commercial operations. However, DEQ
has determined that remediation wastes merit special consideration with regard to the levy of
...
This IMD examines which generator fees apply to remediation waste based on two conditions: 1)
Whether the waste is managed on-site or shipped off-site for treatment, storage or disposal, and
2) whether it was generated from cleanup activities conducted under DEQ or EPA oversight
through a formal agreement or order. The IMD also notes the applicable waste management
requirements to on- and off-site remediation waste.
...
wastes, are wastes that are generated from field investigation activities, approved and overseen
by DEQ or EPA, that are specifically designed to determine the nature and extent of
contamination. IDW is typically generated during the site assessment, remedial investigation or
feasibility study stage of a cleanup project. The critical determination to be made prior to
categorizing waste as IDW is whether the waste was generated from an activity related to
determining the nature and extent of contamination. IDW includes, but is not limited to: drilling
mud, cuttings, and purge water from test borings and well installation; purge water, soil and
other materials from collection of samples; contaminated personnel protective equipment, and
solutions used to decontaminate non-disposable protective clothing and equipment used during
field investigation activities. IDW does not include wastes that are generated from actual
...
groundwater, surface water, soils and sediments) and debris that contain listed hazardous waste
or that themselves exhibit a hazardous characteristic and are managed for implementing cleanup.
For purposes of this policy, remediation wastes subject to the exemption are those that are
generated as a result of cleanup actions conducted under a formal agreement or order with DEQ
or EPA. This includes waste generated from removal or remedial activities (including spill
response activities) being conducted under the authority of Oregon’s Cleanup Program through a
formal agreement or order, RCRA corrective actions, and Federal Superfund actions.
...
7.4   Provisional RCRA Site ID Numbers:
      ...
      7.4.2 Entering provisional numbers into Your DEQ Online. The process for
      entering provisional numbers will include:
             1. Once a month the Cleanup Program’s Emergency Response Team will
                 ...
                 Number Contact to request the numbers be entered into Your DEQ
                 Online. The email will include the Cleanup Project number, the
                 provisional number issued, the address the number was issued to, and
                 any other information available about the site.
             2. The RCRA Site ID Number Contact will input the number into Your
                 DEQ Online. If the address that is being issued a provisional number is
                 already assigned a number in Your DEQ Online, the Multiple ID
                 number policy should be followed to come up with an alternate
                 address to issue the provisional number to.
...
7.4.3 Closing out provisional numbers.
       ...
       3. Upon receiving an email from the Cleanup Program, the RCRA Site
          ID number Contact will withdraw the number from Your DEQ Online.
...
with the following exceptions:
        ...
        2. The RCRA Site ID number Contact will input the provisional number
            into Your DEQ Online with the appropriate EPA contact included.
...
8. List of tables and/or figures [if applicable]
  ...
  REMEDIATION WASTE
                                      Do not count towards generator status.      Count toward generator status.

                                      Report waste generation and management      Report waste generation and
                                      in annual HAZARDOUS WASTE report.           management in annual HW report.
                                     No fees apply.                              Annual HW activity verification fee
                                     Wastes are managed under site-specific      (based on generator status) and HW
                                      requirements of cleanup program order or    generation fee (based on quantity and
                                      formal agreement; does not apply to         management method) apply.
                                      voluntary letter agreement or independent   Generator must manage as hazardous
                                      cleanup program agreement.                  wastes (e.g., manifesting, use of a TSD
                                                                                  facility).
  ...
  INVESTIGATION-DERIVED
                          ...
                          WASTE
                                      ...
                                      Wastes are managed under site-specific      apply if cleanup is conducted under
                                      requirements of cleanup program order or    formal State/Federal agreement or order.
                                      formal agreement; does not apply to
                                      voluntary letter agreement or independent   Generator must manage wastes as
                                      cleanup program agreement.                  hazardous waste.

9. Appendices [if applicable]

10. Record of Revisions to IMD
      Revision            Date         Changes            Editor
Cover page       6/2017          Address change   Acomb

## Provenance & change history

- Source: <https://ormswd2.synergydcs.com/ORMSCMSearchDEQ/Search/RecordViewer.aspx?uri=7070267> · retrieved 2026-07-22 · sha256 `dd0e36820e56fbf14f09fc0a537a3e3d2d495e359d65a3ab3b5e379f95318717`
- Snapshot: `_meta/snapshots/deq-imd-7070267.pdf`
