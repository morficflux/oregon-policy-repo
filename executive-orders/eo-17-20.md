...
source_sha256: "22bd9fecbf872c63622f7592f9ea01c6df76f12d5d6457514b08f363d7f85848"
...
State of Oregon
    ...
    change.
        ...
        e     Ocean acidification is increasing and there are changes in ocean currents.
...
State of Oregon
    ...
    WHEREAS, saving energy by using less energy in buildings is one of the least cost
    ways to achieve emissions reductions in the energy system — often with a net            |
    financial savings over the life of these energy efficiency measures, in particular as   |
    ...
    WHEREAS, energy efficiency is a critical and growing portion of the State’s clean
...
State of Oregon
    ...
    WHEREAS, an energy system with distributed generation, energy efficiency, and
...
State of Oregon
    ...
    PAGE 4
         ...
         B, Carbon-Neutral Operations for New State Buildings. DAS and ODOE
         ...
         D. Energy Efficient Equipment. DAS, with support from ODOE, is
      ...
      4. Increasing Energy and Water Efficiency in New Construction Across
         ...
         A. Solar Ready Building Construction. The appropriate advisory board(s)
             and the Department of Business and Consumer Services Building Codes
...
State of Oregon
    ...
    PAGE 5
             ...
             building code to require all newly constructed buildings will be ready
         ...
         B. Electric Vehicle Ready Building Construction. The appropriate advisory
            ...
            residential and commercial buildings are ready to support the
         ...
         C. Zero-Energy Ready Homes. The appropriate advisory board(s) and
            BCD are directed to conduct code amendment of the state building code
             ...
             equivalent performance levels with the 2017 U.S. Department of Energy       |
         ...
         D. Increasing Energy Efficiency in Commercial Construction. The                 |
            appropriate advisory board(s) and BCD are directed to conduct code
             ...
             the measurable prescriptive energy efficiency portions of the most
             current version of ASHRAE 189.1 that are construction-related.                  |
         ...
         E. Helping Key, Expanding Industries to Save Costs by Reducing their
            ...
            savings through building code amendments as it relates to their                  |
             ...
             Governor with a report of its analysis and findings by January 1, 2019.     |
...
State of Oregon
    ...
    PAGE 6
           ...
           F,   Improved State Standards for Appliances. ODOE is directed to work
                ...
                to provide the Governor with a report of its analysis and identify
           ...
           H. Increased Water Efficiency in On-Site Reuse. The appropriate advisory
                ...
                safe reuse of water for irrigation purposes by October 1, 2025.
      ...
      5.   Increasing Energy Efficiency through Retrofits of Existing Buildings
           ...
           A. Energy Trust of Oregon Pilot Programs. Oregon Public Utility
                ...
                programs, including pay-for-performance pilot programs, by January 1,
...
State of Oregon
    ...
    PAGE 7
             ...
             maximum efficiency, as well as a continuum of efficiency levels up to
         ...
         C. Coordination of Data. ODOE and PUC are directed to support and assist
             private sector partners in efforts to coordinate sharing of data that shows
         ...
         Analysis of Cost. State agencies are expected to implement this Executive
         ...
         that directive. All state agency processes for determining deferment of a
...
State of Oregon
    ...
    PAGE 8
      ...
      7,   Implementation. The implementation of this Executive Order shall be
           coordinated through a Built Environment Efficiency Working Group, which
           will also identify any structural barriers or barriers to information sharing
      ...
      8.   The Governor encourages the Secretary of State, the State Treasurer, the
           ...
           Done at Portland, Oregon, this Ooday of November, 2017.                                |
...
- Source: <https://www.oregon.gov/gov/eo/eo_17-20.pdf> · retrieved 2026-07-18 · text-content sha256 `22bd9fecbf872c63622f7592f9ea01c6df76f12d5d6457514b08f363d7f85848`
- Snapshot policy: **hash-only** — executive-order PDFs (mostly large image scans) are not committed to the repo; the text extraction is committed as `_meta/snapshots/eo-17-20.txt`.
