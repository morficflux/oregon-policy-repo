---
id: oar-635-044-0460
title: "Holding of Live Black Bear (Ursus americanus), Cougar (Puma concolor), Bobcat (Lynx rufus), Wolf (Canis lupus), Raccoon (Procyon lotor) and Skunk (Mephitis spp.)"
doc_type: rule
...
# Holding of Live Black Bear (Ursus americanus), Cougar (Puma concolor), Bobcat (Lynx rufus), Wolf (Canis lupus), Raccoon (Procyon lotor) and Skunk (Mephitis spp.) (OAR 635-044-0460)

## At a glance

OAR 635-044-0460 — Holding of Live Black Bear (Ursus americanus), Cougar (Puma concolor), Bobcat (Lynx rufus), Wolf (Canis lupus), Raccoon (Procyon lotor) and Skunk (Mephitis spp.). Chapter 635, Division 044. Statutory authority and AON
