...
# Payment of deposit in multiple-party account to one or more parties; institution not required to determine source or use of funds in account (ORS 708A.485)

## At a glance

ORS 708A.485 — Payment of deposit in multiple-party account to one or more parties; institution not required to determine source or use of funds in account. Chapter 708A (Chapter 708A), 2025 Edition.
