...
# Application fees (ORS 543A.405)

## At a glance

ORS 543A.405 — Application fees. Chapter 543A (Chapter 543A), 2025 Edition.

## Full text

543A.405 Application fees.

(1) Subject to the provisions of ORS 543A.410, any person submitting a notice of intent to seek reauthorization, a preliminary application or an application for reauthorization of a project under ORS 543A.030, 543A.035, 543A.075, 543A.080 or 543A.095 shall pay all expenses related to the review and decision of the Hydroelectric Application Review Team that are incurred by the team and any agency participating as part of the team, and that are not otherwise covered by the fee paid under ORS 543.078.
...
(6) The Water Resources Department shall reimburse participating agencies for costs incurred in their review of a project. Such costs shall not include expenses of other state agencies for which a fee is otherwise collected under state law. [1997 c.449 §33; 2001 c.369 §7; 2021 c.516 §7] 
