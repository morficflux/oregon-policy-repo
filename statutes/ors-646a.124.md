...
# General disclosure requirements (ORS 646A.124)

## At a glance

ORS 646A.124 — General disclosure requirements. Chapter 646A (Chapter 646A), 2025 Edition.

## Full text

646A.124 General disclosure requirements.

(1) The lessor shall disclose to the consumer the information required by ORS 646A.126. In a transaction involving more than one lessor, only one lessor need make the disclosures, but all lessors shall be bound by the disclosures.
