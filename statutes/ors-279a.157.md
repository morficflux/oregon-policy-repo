---
id: ors-279a.157
title: "State contracting agency use of contract form, contract template or solicitation template; exceptions and exemptions; rules"
doc_type: statute
citation: "ORS 279A.157"
...
# State contracting agency use of contract form, contract template or solicitation template; exceptions and exemptions; rules (ORS 279A.157)

## At a glance

ORS 279A.157 — State contracting agency use of contract form, contract template or solicitation template; exceptions and exemptions; rules. Chapter 279A (Public Contracting - General Provisions), 2025 Edition.
...
(4) The Attorney General and the Director of the Oregon Department of Administrative Services shall cooperate to: (a) Develop and make available solicitation templates, contract forms and contract templates for procurements or classes of procurements that state contracting agencies require; and (b) Adopt rules under ORS 279A.065 to implement the provisions of this section. [2015 c.646 §2; 2019 c.55 §2] 
