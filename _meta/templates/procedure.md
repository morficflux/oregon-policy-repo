---
# ---- Identity ----
id: das-XXX-XXX-XXX_pr                  # required; stable slug = filename (ends _pr)
title: "TITLE"                          # required
doc_type: procedure                     # required
citation: "DAS Statewide Procedure XXX-XXX-XXX_PR"
# ---- Authority ----
...
relationships:
  implements: []                        # the policy this procedure implements, e.g. ["das-XXX-XXX-XXX"]
  implemented_by: []
  references_external: []
  related: []
  supersedes: []
...
_1–3 sentence plain-language summary — what this procedure operationalizes and for the_
_policy it implements. Curator-authored content may appear ONLY here, under Curator_
_notes, and under Cross-references._
...
- _In-repo relative links: the policy this procedure implements (`../policies/...`),_
  _related procedures._
